...
/**
* HWSErrorParser used to compose custom NSError from response body when request finished
* with error status code (For example 4xx or 5xx codes)
* */
@protocol HWSErrorParser<NSObject>
...
* - nil when 'responseBodyOutputStream' specified in HWSRequest
* */
- (NSError *)errorFromResponseBody:(id)bodyObject headers:(NSDictionary *)headers status:(HttpStatusCode)statusCode error:(NSError **)error;
