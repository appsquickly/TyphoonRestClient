...
git remote add origin git@github.com:appsquickly/TyphoonRestClient.git || true # allow `remote add` to fail without failing script
git remote set-url origin git@github.com:appsquickly/TyphoonRestClient.git
