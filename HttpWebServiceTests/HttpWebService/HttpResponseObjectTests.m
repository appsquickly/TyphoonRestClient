...
@interface HttpResponseObjectTests : XCTestCase<HWSValueConverterRegistry>

@end

@implementation HttpResponseObjectTests
...
{
    HWSConverter *object = [[HWSConverter alloc] initWithResponseValue:data schemaValue:schemaArrayOrDictionary schemaName:@"test"];
...
{
    HWSConverter *object = [[HWSConverter alloc] initWithRequestValue:data schemaValue:schemaArrayOrDictionary schemaName:@"test"];
    object.registry = self;
    if (errorsSet) {
        *errorsSet = object.conversionErrorSet;
    }
